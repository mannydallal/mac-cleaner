...
import { scanSystem, cleanPaths, scanApps, getSizeOf, getDiskHealth, verifyDiskVolume, virusScan, checkFullDiskAccess, getParallelsInfo, ScanResult, AppInfo } from "./scanner";
